        ...
        actionMapView = Row(
          children: [
            ...
            Container(
              ...
              child: IconButton(
                enableFeedback: true,
                icon: const Icon(HugeIcons.strokeRoundedMapsSearch),
                onPressed: () {
                  _onLocation(product);
                },
              ),
        ...
        SliverAppBar(
          ...
          flexibleSpace: ClipRRect(
            borderRadius: BorderRadius.only(
              bottomLeft:
                  Radius.circular(15.0), // Zaobljenje donjeg lijevog ugla
              bottomRight:
                  Radius.circular(15.0), // Zaobljenje donjeg desnog ugla
            ),
