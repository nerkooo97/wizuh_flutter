...
class _ProductListState extends State<ProductList> {
  ...
  IconData _exportIconView() {
    ...
    switch (_listMode) {
      case ProductViewType.list:
        return HugeIcons.strokeRoundedListView;
      case ProductViewType.grid:
        return HugeIcons.strokeRoundedLeftToRightListDash;
      case ProductViewType.block:
  ...
  Widget build(BuildContext context) {
    IconData iconAction = HugeIcons.strokeRoundedMapsLocation01;
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: const Icon(HugeIcons.strokeRoundedPreferenceHorizontal),
                    ),
                  ),
                ],
              ),
