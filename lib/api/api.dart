...
import 'package:listar_flutter_pro/api/http_manager_v2.dart';
import 'package:listar_flutter_pro/models/model.dart';
import 'package:listar_flutter_pro/utils/utils.dart';

class Api {
  static final httpManager = HTTPManager();
  static final httpManagerV2 = HTTPManagerV2();
  ...
  static const String autobuskeLinije = "/wiezuhause/v1/rute";
  static const String autobuskeLinijeGradovi = "/wiezuhause/v1/gradovi";
  ...
  ///Get Autobuske linije
  static Future<ResultApiModel> requestAutobuskeLinije() async {
    final result = await httpManager.get(
      url: autobuskeLinije,
    );
    return ResultApiModel.fromJson(result);
  ...
  ///Get Autobuske linije
  static Future<ResultApiModel> requestAutobuskeLinijeGradovi() async {
    final result = await httpManager.get(
      url: autobuskeLinijeGradovi,
    );
    return ResultApiModel.fromJson(result);
  }
...
/*   static Future<ResultApiModel> requestPaymentConfig() async {
  ...
  ///Get Events
  static Future<ResultApiModel> requestEvent(params) async {
    final result = await httpManagerV2.get(url: event, params: params);
    return ResultApiModel.fromJson(result);
  }
